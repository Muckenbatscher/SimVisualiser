...
{
    internal class TCEventTiggerService : GameEventTriggerService, IGameEventTriggerService<bool>
    {
        private static readonly string GameEventName = GameEventMetadata.TC_ACTIVE_EVENT_NAME;
        public TCEventTiggerService(TargetAddress baseAddress) : base(baseAddress, GameEventName)
        {
        }
